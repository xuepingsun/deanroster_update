# Generated by Django 3.2.25 on 2024-11-24 20:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_category', models.ManyToManyField(blank=True, to='roster.SchoolCategory', verbose_name='学科大类')),
            ],
            options={
                'verbose_name': '院系名单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dean_info', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='roster.deanbasic')),
            ],
            options={
